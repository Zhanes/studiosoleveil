...
define("HOST_NAME", "Studio Soleveil");
define("HOST_EMAIL", "contact@studiosoleveil.ch");

// Define SMTP Credentials || Gmail Informations
define("SMTP_EMAIL", "adrian.benchmark@gmail.com");
define("SMTP_PASSWORD", "gsvglcumyeoignmb"); // read documentations


// Define Recipent Info ||  Who will get this email?
define("RECIPIENT_NAME", "Studio Soleveil");
define("RECIPIENT_EMAIL", "contacter@studiosoleveil.ch");
