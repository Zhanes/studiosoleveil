// JavaScript Document
	...
	if(lng=='es') {
		...
		var asmconfig = {
			...
			aviso : "<p>Ce site utilise des cookies nécessaires, et d'autres qui sont utilisés pour des fonctions avancées, des statistiques ou des actions de marketing. Pour plus d'informations, vous pouvez consulter la page  <a href='/cookies-and-privacy-policy' class='asm-more-info'>Politique de cookies et de confidentialité</a>.</p>",
			aviso2 : '',
